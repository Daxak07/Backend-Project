    ...
    <body onload="load()">
        <header class="header" id="header">
            ...
            <div style="display: flex;">
                <a href="/" style="margin-top: 32px">{{__("English")}}</a>
                <a href="/ru" style="margin-top: 32px">{{__("Russian")}}</a>
            </div>
            <!-- <a href="/kz">Кazakh</a> -->
                ...
                <div class="container">
                    ...
                    <div class="images">
                        ...
                        <div class="text1">
                            ...
                            <h4 class="h4">{{ __("Family Drama")}}</h4>
                        </div>
        ...
        <div class="intro__content2" id="intro__content2">
            ...
            <!-- <div class="intro__content2_inner">
                <div class="inner_block">
                    <div class="intro__content2_inner_text">
                        <h4 id="LatestNewsText">{{ __("Hometown Season")}}</h4>
                        <div class="date">
                        {{ __("November 18")}}
                        </div>
                    </div>
            ...
            <div class="intro__content2_inner">
               <div class="inner_block">
                    <div class="intro__content2_inner_text">
                        <h4 id="LatestNewsText">{{ __("Joker Deepfake")}}</h4>
                        <div class="date">
                        {{ __("November 17")}}
                        </div>
                    </div>
                    <div class="content2_text">
                        {{ __("Joker deepfake video")}}
                    </div>
                </div>
            ...
            <div class="intro__content2_inner">
               <div class="inner_block">
                    <div class="intro__content2_inner_text">
                        <h4 id="LatestNewsText">{{__("Captain")}}</h4>
                        <div class="date">
                        {{ __("November 16")}}
                        </div>
                    </div>
        ...
        <div class="trailers" id="trailers">
            <div class="trailers__inner">
                <p id="Trailers">{{ __("New Trailers")}}</p>
        ...
        <div class="section">
            <div class="section_text">
                ...
                <a href="#" class="btn1 btn1--white" onclick="notReady()">{{__("Read More")}}</a>
            </div>
        ...
        <!-- <div class="episodes">
            <p class="paragraph" id="episode">{{__("Latest Episodes")}}</p>
        ...
        <div class="footer">
            <div class="footer__intro">
                <div class="footer__title">
                    <p style="font-size: 20px">{{__("Subscribe")}}</p>
                ...
                <div class="footer_link">
                    <div class="footer__links">
                        <p class="links">{{__("Movies")}}</p>
                        <a class="links" href="#">{{__("Action")}}</a>
                        <a class="links" href="#">{{__("Drama")}}</a>
                        <a class="links" href="#">{{__("Science Fiction")}}</a>
                        <a class="links" href="#">{{__("Fantasy")}}</a>
                        <a class="links" href="#">{{__("Horror")}}</a>
                    </div>
                    <div class="footer__links">
                        <p class="links">{{__("TV Shows")}}</p>
                        <a class="links" href="#">{{__("The Night Watch")}}</a>
                        <a class="links" href="#">{{__("Hometown")}}</a>
                        <a class="links" href="#">{{__("Nerds")}}</a>
                        <a class="links" href="#">{{__("The Good Girls")}}</a>
                        <a class="links" href="#">{{__("Keat's Crew")}}</a>
                        <a class="links" href="#">{{__("Corona")}}</a>
                    </div>
                    <div class="footer__links">
                        <p class="links">{{__("Framerate")}}</p>
                        <a class="links" href="#">{{__("About")}}</a>
                        <a class="links" href="#">{{__("Terms of Use")}}</a>
                        <a class="links" href="#">{{__("Nerds")}}</a>
                    </div>
                </div>
            </div>
